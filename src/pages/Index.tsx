...
const CATEGORIES = [
  { icon: 'PaintBucket', name: 'Лакокрасочные материалы', count: 'Краски, эмали, лаки', tag: 'ФИНИШ' },
  { icon: 'Droplets', name: 'Грунтовки и пропитки', count: 'Защита и адгезия', tag: 'ОСНОВА' },
  { icon: 'Layers', name: 'Сухие строительные смеси', count: 'Штукатурки, шпаклёвки', tag: 'ОСНОВА' },
  { icon: 'Palette', name: 'Колеровка краски', count: 'Компьютерный подбор', tag: 'ЦВЕТ' },
  { icon: 'Brush', name: 'Малярный инструмент', count: 'Кисти, валики, ленты', tag: 'РАБОТА' },
  { icon: 'Flame', name: 'Газ и монтажная химия', count: 'Баллоны KUDO, пены', tag: 'МОНТАЖ' },
];

const PRODUCTS = [
  { name: 'Краска интерьерная моющаяся, супербелая', price: '1 290 ₽', unit: '/ 14 кг', cat: 'Краски' },
  { name: 'Эмаль алкидная ПФ-115 универсальная', price: '690 ₽', unit: '/ 2.7 кг', cat: 'Эмали' },
  { name: 'Грунтовка глубокого проникновения', price: '450 ₽', unit: '/ 10 л', cat: 'Грунтовки' },
  { name: 'Шпаклёвка финишная полимерная', price: '620 ₽', unit: '/ 20 кг', cat: 'Смеси' },
  { name: 'Штукатурка гипсовая универсальная', price: '480 ₽', unit: '/ 30 кг', cat: 'Смеси' },
  { name: 'Лак яхтный алкидно-уретановый, глянец', price: '890 ₽', unit: '/ 2.5 л', cat: 'Лаки' },
  { name: 'Валик меховой 250 мм + бюгель', price: '320 ₽', unit: '/ набор', cat: 'Инструмент' },
  { name: 'Газ универсальный всесезонный KUDO', price: '290 ₽', unit: '/ балл.', cat: 'Газ KUDO' },
  { name: 'Пена монтажная профессиональная, 750 мл', price: '410 ₽', unit: '/ шт', cat: 'Химия' },
];

const SERVICES = [
  { icon: 'Palette', title: 'Компьютерная колеровка', text: 'Подберём и заколеруем краску в любой оттенок по образцу или вееру.' },
  { icon: 'Truck', title: 'Доставка по югу России', text: 'Привезём заказ по Ростову и всему Южному федеральному округу.' },
